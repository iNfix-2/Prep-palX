...
| School administrator | `dashboard.view`, `account.manage_self`, `workspace.select`, `school.settings.manage`, `staff.manage`, `class.manage`, `task.view`, `task.manage`, `support.view`, `support.request`, `support.manage`, `timetable.view`, `calendar.view`, `timetable.manage`, `attendance.record`, `attendance.view_reports`, `lesson.view`, `lesson.create`, `assessment.view`, `assessment.create`, `assessment.mark`, `question.view`, `question.manage`, `resource.view`, `resource.manage`, `gradebook.view`, `report.review`, `approval.view`, `approval.review`, `ai.use`, `audit.view` | Admin/dashboard/settings/staff/classes/tasks/support/reports/approvals/Ask Pal | dashboard, account settings, assistant, and school management APIs | staff/learner PII, dashboard summaries, account preferences, AI context/proposals, tasks, support requests, attendance, lesson notes, timetable events, calendar events, resources, assessment content, question content, scores, audit logs | Own school only |
| Teacher | `dashboard.view`, `account.manage_self`, `workspace.select`, `task.view`, `task.manage`, `support.view`, `support.request`, `class.view_assigned`, `timetable.view`, `calendar.view`, `lesson.view`, `lesson.create`, `attendance.record`, `attendance.view_reports`, `assessment.view`, `assessment.create`, `assessment.mark`, `question.view`, `question.manage`, `resource.view`, `resource.manage`, `gradebook.view`, `report.prepare`, `approval.view`, `ai.use` | Teacher dashboard, settings, tasks, support, classes, timetable, academic calendar, lesson planner, attendance, assessments, question bank, resources, gradebook, reports, approvals, Ask Pal | teacher dashboard APIs, account settings APIs, teacher task APIs, support APIs, assistant APIs, teacher class APIs, timetable APIs, academic calendar APIs, lesson plan APIs, attendance APIs, assessment APIs, question APIs, resource APIs, gradebook APIs, approval tracking APIs | learner scores, dashboard summaries, account preferences, AI context/proposals, tasks, support requests, attendance, timetable events, calendar events, resources, lesson notes, assessment content, question content, comments | Assigned classes unless broader permission |
...
| `/my-tasks` | `task.view` or `task.manage` scoped to owner, assignee, workspace task, assigned class, or `class.manage` |
| `/my-tasks/[taskId]` | `task.view` for read; `task.manage` for status updates scoped to owner, assignee, workspace task, assigned class, or `class.manage` |
| `/help` | `support.view`, `support.request`, or `support.manage`; request creation requires `support.request` or `support.manage` |
| `/help/[requestId]` | `support.view`, `support.request`, or `support.manage` scoped to creator, assignee, or support manager; status changes require `support.manage` |
| `/settings` | `account.manage_self`; workspace switch requires `workspace.select`; AI source preferences require `ai.use` |
