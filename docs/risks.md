...
- Authentication and tenant isolation exist only for the first demo-backed `/api/v1`
  class slice; production auth, durable sessions, and database-backed tenant checks
  are still required.
