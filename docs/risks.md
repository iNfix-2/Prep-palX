...
- Authentication and tenant isolation exist only for the demo-backed `/api/v1`
  tasks, help/support, classes, attendance, lesson-planner, assessment, question-bank, timetable,
...
- No durable audit logging yet for sensitive school operations, support requests, or approval decisions.
